...
class CreateAlfStudentInfomationTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('alf_student_infomation', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('alf_student_infomation');
    }
}
